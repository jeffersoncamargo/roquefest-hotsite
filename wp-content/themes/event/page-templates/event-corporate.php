					...
					<div class="container">
						...
						<?php if($event_get_booking_posts->have_posts()):$event_get_booking_posts->the_post();
							if($i==1 &&  $event_settings['event_title'] !=''){
								...
								<li><i class="fa fa-calendar"></i><?php echo esc_html($event_booking_title_attribute); ?></li>
								<?php $i++;
							}
						endif;
						...
						<?php if($event_settings['event_book_appointment_url']!=''){ ?>
							<a target="_blank" class="appointment-btn btn-eff" href="<?php echo esc_url($event_settings['event_book_appointment_url']); ?>"><i class="fa fa-pencil-square-o"></i><?php echo esc_html($event_settings['event_book_appointment']); ?></a>
						<?php }else{ ?>
							<a target="_blank" class="appointment-btn btn-eff" href="<?php the_permalink(); ?>"><i class="fa fa-pencil-square-o"></i><?php echo esc_html($event_settings['event_book_appointment']); ?></a>
						<?php } ?>
						</div>
						<?php  } ?>
					</div>	
